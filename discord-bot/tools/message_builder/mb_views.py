...
<<<<<<< HEAD:tools/message_builder/mb_views.py
    """
    Subclass representing compiled Layout V2 configurations, managing
    timeout hooks, expirations, and safe callbacks.
    """
=======
>>>>>>> 982e394 (feat: initial monorepo setup for discord bot and github app):discord-bot/tools/message_builder/mb_views.py
