...
class AppInstallationClient:
    """Client authenticated with GitHub App Installation Token for background repo ops."""
    ...
    async def get_issue_linked_branch(
        ...
        """Queries GraphQL for any development branch linked to this issue under Development."""
        query = """
    ...
    async def get_sub_issues(
        ...
        """Fetches any child sub-issues attached to this issue."""
    ...
    async def add_sub_issue(
        ...
        """Natively attaches a child issue to a parent issue on GitHub."""
    ...
    async def create_check_run(
        ...
        """Creates a native GitHub Check Run with status and detailed output."""
...
class MachineUserClient:
    """Client authenticated as the Machine Account (PAT / GITHUB_TOKEN)."""
