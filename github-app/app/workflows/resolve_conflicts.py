...
async def handle_resolve_conflicts(
    ...
    """
    Resolves merge conflicts between base branch and PR head branch:
    - Checks Caller Authorization (Maintainer or PR Author).
    - Pushes a true 2-parent Git merge commit [head_sha, base_sha] if authorized.
    - Gracefully outputs clean suggested code if caller lacks write access.
    """
